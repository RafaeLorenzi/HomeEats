...
alter table municipalities  auto_increment = 1 ;
...
insert ignore into kitchen (id, name) values (1, 'thai');
insert ignore into kitchen (id, name) values (2, 'Indian');
insert ignore into kitchen (id, name) values (3, 'Argentina');
insert ignore into kitchen (id, name) values (4, 'Brazilian');
