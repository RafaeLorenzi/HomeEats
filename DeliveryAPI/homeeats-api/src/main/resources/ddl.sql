...
create table district (id bigint not null auto_increment, name varchar(255) not null, primary key (id)) engine=InnoDB;
...
create table item (id bigint not null auto_increment, active bit not null, description varchar(255) not null, name varchar(255) not null, price decimal(19,2) not null, restaurant_id bigint not null, primary key (id)) engine=InnoDB;
create table kitchen (id bigint not null auto_increment, name varchar(255) not null, primary key (id)) engine=InnoDB;
create table municipalities (id bigint not null auto_increment, name varchar(255) not null, district_id bigint not null, primary key (id)) engine=InnoDB;
...
create table restaurant (id bigint not null auto_increment, adress_complement varchar(255), postal_code varchar(255), adress varchar(255), delivery_fee decimal(19,2) not null, name varchar(255) not null, register_date datetime not null, update_date datetime not null, adress_municipalities_id bigint, kitchen_id bigint not null, primary key (id)) engine=InnoDB;
...
create table user_grup (user_id bigint not null, group_id bigint not null) engine=InnoDB;
alter table group_permission add constraint FKss14p30qbokhpkpdov4ha3wro foreign key (permission_id) references permission (id);
alter table group_permission add constraint FK4twq9e99a6jwgl699bqlu5tsc foreign key (group_id) references group (id);
alter table item add constraint FK2ip7t8cv2p1ghfi1e796yet7d foreign key (restaurant_id) references restaurant (id);
alter table municipalities add constraint FKbhlf1vwq4ecsp1ht2epaxwk7j foreign key (district_id) references district (id);
